    ...
    () {
      test(
        ...
        () {
          ...
          expect(
            converted,
            const fixture.With<num, num>(first: 18, second: 789),
          );
        },
      );
      test(
        'With<Object, Object> -> With<Object, Object>',
        () {
          ...
          expect(
            converted,
            const fixture.With<Object, Object>(first: 'Some string', second: 123123),
          );
        },
      );
      test(
        'With<int, AlphaDto<num>> -> With<int, Alpha<num>>',
        () {
          const dto = fixture.With<int, fixture.AlphaDto<num>>(
            first: 69,
            second: fixture.AlphaDto<num>(
              fixture.With<num, num>(
                first: 741,
                second: 852.666,
              ),
              123,
      ...
      test(
        ...
        () {
          ...
          expect(
            converted,
            const fixture.Without(first: 'test abc', second: 111222333),
          );
        },
      );
      test(
        'With<String, int> -> With<String, int>',
        () {
          ...
          expect(
            converted,
            const fixture.With<String, int>(first: 'test abc 2', second: 741852963),
          );
        },
      );
      test(
        'Without -> With<String, int>',
        () {
          ...
          expect(
            converted,
            const fixture.With<String, int>(first: 'alpha test', second: 111000),
          );
        },
      );
    },
    ...
    () {
      test(
        ...
        () {
          ...
          expect(
            converted,
            const fixture.Alpha<num>(fixture.With<num, num>(first: 1, second: 2), 420),
          );
        },
      );

      test(
        'AlphaDto<int> -> Alpha<int>',
        () {
          ...
          expect(
            converted,
            const fixture.Alpha<int>(fixture.With<int, int>(first: 7771, second: 1472), 42),
          );
        },
      );

      test(
        'AlphaDto<String> -> Alpha<String>',
        () {
          ...
          expect(
            converted,
            const fixture.Alpha<String>(fixture.With<String, String>(first: 'test a', second: 'test b'), 42),
          );
        },
      );
    },
    ...
    () {
      test(
        ...
        () {
          ...
          final converted = mappr.convert<fixture.ListHolder<int, fixture.AlphaDto<num>>,
              fixture.ListHolder<int, fixture.Alpha<num>>>(dto);
      ...
      test(
        'SetHolder<String> -> SetHolder<String>',
        () {
      ...
      test(
        'IterableHolder<String, int> -> IterableHolder<String, int>',
        () {
          final dto = fixture.IterableHolder<String, int>(
            {
              const fixture.With<String, int>(
                first: 'beta y1',
                second: 4201,
              ),
              const fixture.With<String, int>(
          ...
          final converted =
              mappr.convert<fixture.IterableHolder<String, int>, fixture.IterableHolder<String, int>>(dto);
