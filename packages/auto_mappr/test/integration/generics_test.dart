...
void main() {
  ...
  group('simple', () {
    ...
    test('With<Object, Object> -> With<Object, Object>', () {
      ...
      expect(converted, equals(const fixture.With<Object, Object>(first: 'Some string', second: 123123)));
    });
    ...
    test('With<String, int> -> Without', () {
      const dto = fixture.With(first: 'test abc', second: 111222333);
      final converted = mappr.convert<fixture.With<String, int>, fixture.Without>(dto);

      expect(converted, equals(const fixture.Without(first: 'test abc', second: 111222333)));
    });
    test('With<String, int> -> With<String, int>', () {
      const dto = fixture.With(first: 'test abc 2', second: 741852963);
      final converted = mappr.convert<fixture.With<String, int>, fixture.With<String, int>>(dto);

      expect(converted, equals(const fixture.With<String, int>(first: 'test abc 2', second: 741852963)));
    });
    test('Without -> With<String, int>', () {
      ...
      expect(converted, equals(const fixture.With(first: 'alpha test', second: 111000)));
    });
  });
