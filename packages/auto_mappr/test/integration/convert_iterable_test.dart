...
void main() {
  ...
  group(
    ...
    () {
      ...
      test(
        'convertIterable with null throws',
        () {
          expect(
      ...
      test(
        'convertIterable with null and default value does not throw',
        () {
      ...
      test(
        'tryConvertIterable with null and default value',
        () {
  ...
  group(
    ...
    () {
      ...
      test(
        'convertList with null and default value does not throw',
        () {
      ...
      test(
        'tryConvertList with null and default value',
        () {
  ...
  group(
    ...
    () {
      ...
      test(
        'convertSet with null and default value does not throw',
        () {
      ...
      test(
        'tryConvertSet with null and default value',
        () {
