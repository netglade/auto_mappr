  ...
  group(
    ...
    () {
      test('with note', () {
        ...
        expect(
          converted,
          const fixture.Positional(18, 'John', 'test note'),
        );
      });
      ...
      test('without note', () {
        ...
        expect(
          converted,
          const fixture.Positional(28, 'Steven'),
        );
      });
    },
  );
  ...
  group(
    ...
    () {
      test('with note', () {
        ...
        expect(
          converted,
          const fixture.Named(age: 9421, name: 'Thomas', note: 'note note'),
        );
      });
      ...
      test('without note', () {
        ...
        expect(
          converted,
          const fixture.Named(age: 78438, name: 'Carol'),
        );
      });
    },
  );
  ...
  group(
    ...
    () {
      test('with note', () {
        ...
        expect(
          converted,
          const fixture.Positional(753000, 'Daniel', 'alpha note'),
        );
      });
      ...
      test('without note', () {
        ...
        expect(
          converted,
          const fixture.Positional(1001, 'Jake'),
        );
      });
    },
  );
  ...
  group(
    ...
    () {
      test('with note', () {
        ...
        expect(
          converted,
          const fixture.Named(age: 741852963, name: 'Peter', note: 'xyz note'),
        );
      });
      ...
      test('without note', () {
        ...
        expect(
          converted,
          const fixture.Named(age: 987321465, name: 'Mike'),
        );
      });
    },
  );
